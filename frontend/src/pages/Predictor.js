...
const css = `
  ...
  .pred-title { font-family: var(--display); font-size: 36px; font-weight: 600; letter-spacing: -0.01em; }
  ...
  .pred-select { background: var(--surface2); border: 1px solid var(--border); border-radius: 8px; color: var(--text);
    font-family: var(--body); font-size: 14px; padding: 10px 14px; outline: none; min-width: 220px; }
  .pred-select:focus { border-color: var(--red); }
  .pred-toggle { display: inline-flex; border: 1px solid var(--border); border-radius: 8px; overflow: hidden; }
  ...
  .matchup-card { background: var(--surface); border: 1px solid var(--border); border-radius: 10px; padding: 32px; margin-bottom: 28px; }
  .matchup-grid { display: grid; grid-template-columns: 1fr auto 1fr; align-items: center; gap: 20px; }
  .team-side { text-align: center; }
  .team-abbr { font-family: var(--display); font-size: 40px; font-weight: 600; letter-spacing: -0.01em; }
  ...
  .team-prob { font-family: var(--display); font-size: 56px; font-weight: 700; line-height: 1; margin-top: 14px; }
  .team-score { font-size: 13px; color: var(--muted); margin-top: 6px; }
  .vs { font-family: var(--display); font-size: 22px; font-weight: 700; color: var(--border); }
  ...
  .power-card { background: var(--surface); border: 1px solid var(--border); border-radius: 10px; overflow: hidden; }
  ...
  .power-table td.num { text-align: right; font-family: var(--display); font-size: 16px; font-weight: 600; }
  .power-table tr:last-child td { border-bottom: none; }
  .power-table tr.hou-row td { background: rgba(206,17,65,0.08); }
  .power-rank { font-family: var(--display); font-weight: 700; color: var(--border); }
      ...
      {loading ? <div className="loading">Building Elo ratings…</div> : (
        <>
          ...
          <div className="section-header" style={{ display:"flex", alignItems:"center", gap:12, marginBottom:16 }}>
            <div style={{ fontFamily:"var(--display)", fontSize:20, fontWeight:700, letterSpacing:2, textTransform:"uppercase" }}>League Power Ratings</div>
