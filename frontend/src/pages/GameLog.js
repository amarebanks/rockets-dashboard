...
const css = `
  ...
  .filter-btn { font-family:var(--display); font-size:11px; letter-spacing:2px; text-transform:uppercase;
    padding:6px 14px; border-radius:8px; border:1px solid var(--border); background:transparent; color:var(--muted); cursor:pointer; transition:all 0.15s; }
  ...
  .streak-info { margin-left:auto; font-family:var(--display); font-size:14px; letter-spacing:1px; }
  .streak-info.W { color:var(--green); }
  .streak-info.L { color:var(--red); }
  .gl-table-wrap { background:var(--surface); border:1px solid var(--border); border-radius:10px; overflow:hidden; margin-bottom:24px; }
  ...
  .modal-title { font-family:var(--display); font-size:24px; font-weight:700; letter-spacing: -0.01em; }
  .modal-subtitle { font-size:12px; color:var(--muted); margin-top:4px; letter-spacing:1px; }
  .modal-score { font-family:var(--display); font-size:42px; font-weight:600; line-height:1; text-align:right; }
  .modal-close { background:none; border:1px solid var(--border); color:var(--muted); width:32px; height:32px; border-radius:8px; cursor:pointer; font-size:18px; display:flex; align-items:center; justify-content:center; flex-shrink:0; margin-left:16px; }
  ...
  .box-table td { padding:9px 12px; border-bottom:1px solid var(--border); text-align:right; font-family:var(--display); font-size:15px; }
  .box-table td:first-child { text-align:left; font-family:var(--body); font-size:13px; font-weight:500; }
  ...
  .export-btn { font-family:var(--display); font-size:10px; letter-spacing:2px; text-transform:uppercase; background:transparent; border:1px solid var(--border); color:var(--muted); padding:4px 10px; border-radius:8px; cursor:pointer; }
  .export-btn:hover { border-color:var(--text); color:var(--text); }
  .playoff-badge { font-size:10px; letter-spacing:1px; text-transform:uppercase; color:#a78bfa; border:1px solid #a78bfa; padding:2px 6px; border-radius:8px; margin-left:8px; }
`;
              ...
              {games.map((g,i) => {
                ...
                return (
                  <tr key={g.game_id} onClick={() => openGame(g)}>
                    ...
                    <td className="r">
                      <span style={{ color:diff>0?"var(--green)":diff<0?"var(--red)":"var(--muted)", fontFamily:"var(--display)", fontSize:16 }}>
