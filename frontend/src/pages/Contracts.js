...
const css = `
  ...
  .ct-title { font-family:var(--display); font-size:36px; font-weight:600; letter-spacing: -0.01em; }
  ...
  .ct-line { background:var(--surface); border:1px solid var(--border); border-radius:10px; padding:10px 16px; min-width:120px; }
  .ct-line .lab { font-size:10px; letter-spacing:2px; text-transform:uppercase; color:var(--muted); }
  .ct-line .val { font-family:var(--display); font-size:24px; font-weight:800; margin-top:2px; }
  .ct-row { background:var(--surface); border:1px solid var(--border); border-radius:10px; padding:12px 16px; margin-bottom:8px;
  ...
  .ct-abbr { font-family:var(--display); font-size:20px; font-weight:800; letter-spacing:1px; }
  ...
  .ct-pay { font-family:var(--display); font-size:22px; font-weight:800; text-align:right; }
  ...
  .ct-relief h4 { font-family:var(--display); font-size:14px; letter-spacing:1px; text-transform:uppercase; margin:0 0 4px; }
  ...
  .ct-move .sv { text-align:right; font-family:var(--display); font-weight:800; color:var(--green); }
  ...
  .ct-cut b { color:var(--text); font-family:var(--display); }
  ...
  .ct-roster .rs { text-align:right; color:var(--gold); font-family:var(--display); font-weight:700; }
